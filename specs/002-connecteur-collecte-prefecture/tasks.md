...
- [ ] T032 [P] [US2] Migrate `prefecture-77` to a declarative config `backend/src/connecteurs/configs/prefecture-77.yaml` + add `type_connecteur: page_web` to its entry in `backend/src/data/connecteurs.json`
- [ ] T033 [P] [US2] Migrate `prefecture-13` to a declarative config `backend/src/connecteurs/configs/prefecture-13.yaml` + add `type_connecteur: page_web` to its entry in `backend/src/data/connecteurs.json`
- [ ] T034 [P] [US2] Migrate `prefecture-33` to a declarative config `backend/src/connecteurs/configs/prefecture-33.yaml` + add `type_connecteur: page_web` to its entry in `backend/src/data/connecteurs.json`
